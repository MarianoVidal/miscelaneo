...
public class MensajeroTest {
    ...
    @Test
    public void test_composite_cifrador() {
    	cc.agregarCifrador(fca);
    	cc.agregarCifrador(rc4a);
    	mensajero.cambiarCifrador(cc);
    	
    	String cadena = "Hola mundo";
    	String cadenaCifrada = rc4.encriptar(fc.encode(cadena), clave2);
    	
    	 assertEquals(cadenaCifrada, mensajero.enviar(cadena));
    	 
    	 String cadenaDescifrada = fc.encode(rc4.desencriptar(cadenaCifrada, clave2));
